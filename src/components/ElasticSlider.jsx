...
export default function ElasticSlider({
  ...
  onChange, // Tambahkan onChange di sini
}) {
  return (
...
function Slider({
  ...
  leftIcon,
  rightIcon,
  onChange, // Terima onChange di sini
}) {
  ...
  const handlePointerMove = (e) => {
    if (e.buttons > 0 && sliderRef.current) {
      ...
      if (onChange) onChange(newValue); // Panggil onChange di sini
    }
  };
